export const client = {
  ...
  tagline: "Professional Landscaping in Aylesford — Quality You Can Trust",
  description: "Professional landscaping services in Aylesford and surrounding areas. Trusted local experts with 65 Google reviews.",
  ...
  seo: {
    title: "Mr A Landscapes Ltd | Professional Landscaping in Aylesford",
    description: "Professional landscaping in Aylesford. 4.9 stars on Google with 65 reviews. Quality workmanship guaranteed.",
  },
};
